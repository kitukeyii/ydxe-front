    ...
    <div class="od-body">
        <div class="dishes">
            <div class="od-title">
                ...
                <ul class="od-class" v-show="searchText">
                    <li v-for="(item,key) in classList" v-bind:key="key" @click="changeClass(key,item.class_id)" :class="{oblActive:classActiveNo === key}">{{item.class_name}}</li>
                </ul>
                <ul class="od-more" v-show="searchText"><li></li><li></li><li></li></ul>
        ...
        <div class="rig-content">
            <div class="right-header">
                ...
                <div class="subtotal r">
                    ...
                    <div>已点{{ordereddiseData.length}}份</div>
                </div>
            </div>
            <div class="order-list" >
                ...
                <!--点餐列表-->
                <ul class="order-dish-list">
                    <li  v-for="(item, key) in ordereddiseData" v-bind:key="key">
                ...
                <!--备注-->
                <div class="dish-list-remark" v-show="remarkcontent">备注：{{remarkcontent}}</div>
                <!--右边初始化页面-->
        ...
        <!--选择人数弹窗-->
        <div class="yun-dialog-body" v-show="dialogVisible">
            <div class="yun-dialog-content">
                <div class="dialog-header">选择人数<i class="iconfont cha" @click="del()" style="font-size: 26px;color: #8c8c8c;">&#xe65a;</i></div>
                <div class="dialog-body"  >
                    <div class="peo-num" contenteditable=true></div>
                    <table class="cal-value" border="1" cellspacing="0">
                        <tr><td>1</td><td>2</td><td>3</td></tr>
                        <tr><td>4</td><td>5</td><td>6</td></tr>
                        <tr><td>7</td><td>8</td><td>9</td></tr>
                        <tr><td>0</td><td colspan="2"><i class="iconfont" style="font-size: 30px;color: #8c8c8c;">&#xe625;</i></td ></tr>
                    </table>
                </div>
            ...
            <div class="yun-dialog-content" style="width:540px;">
                ...
                <div class="dialog-body" style="padding-top:0px;padding-bottom:20px;height:160px;min-height: 160px;margin-left:10px;" >
                    <div class="flavorlist">
                        ...
                        <div class="remarkDetail" contenteditable="true" ref="remarkcontent"></div>
                       <!--   <ul class="flavor-i l">
                            <li>不辣</li>
                            <li>豌豆麻辣味</li>
                            <li>名族麻辣味</li>
...
export default {
  ...
  methods: {
    ...
    placeOrder () {
      ...
      this.accountInfo.data.info.person = 1
