    ...
    <div class="wcc">
      <el-container v-if="flag" class="dishlist">
        <el-aside width="120px">
          <el-menu active-text-color="#ff4141">
            <el-menu-item-group>
              <el-menu-item index="1-1">选项选项现象</el-menu-item>
        ...
        <el-main style="padding:0 0 0 10px">
          <template>
            <el-table
              ...
              <el-table-column prop="date" label="菜品图片" width="80">
                <template  slot-scope="scope">
                  <img src="../../../assets/erweima.png" alt="" width="60" height="60">
                </template>
              </el-table-column>
              <el-table-column prop="name" label="菜品名称" width="120"></el-table-column>
              <el-table-column prop="address" label="菜品编号" show-overflow-tooltip></el-table-column>
